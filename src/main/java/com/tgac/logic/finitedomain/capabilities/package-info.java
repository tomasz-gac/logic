 ...
 * <li><b>Arithmetic</b> — {@link com.tgac.logic.finitedomain.capabilities.Arithmetic},
 * the affine additive half: points and deltas, possibly different types
 * ({@code Instant + Duration}); and
 * {@link com.tgac.logic.finitedomain.capabilities.Multiplicative}, the
 * homogeneous half with the exact-or-refuse inverse. A type may hold
 * one without the other — dates add and never multiply.</li>
 * <li><b>Discreteness</b> — {@link com.tgac.logic.finitedomain.capabilities.Discrete}:
