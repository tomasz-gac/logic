 ...
 * com.tgac.logic.constraints.store.ConstraintStore} is one constraint domain's
 ...
 * com.tgac.logic.constraints.store.Revision}: at most the store's own replaced
 * factor, plus consequences in the driver's vocabulary — inferred
 * {@code Prefix}es (knowledge) and {@link
 * com.tgac.logic.constraints.store.Suspension}s (search effects; the degenerate
 ...
 * com.tgac.logic.constraints.store.Watches} is the shared chain-inclusive matcher;
