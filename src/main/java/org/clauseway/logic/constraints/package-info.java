...
/**
 * The driver layer. {@link org.clauseway.logic.constraints.Constraints} is the user-facing
 * surface (constraint-aware unification and reification); {@link
 * org.clauseway.logic.constraints.Propagation} is the engine: the chokepoint every
 ...
 * {@code org.clauseway.logic.constraints.store} is its entire constraint boundary; how a
